...
/**
 * EdgeniusFilter that compresses output with gzip (assuming that browser supports gzip).
...
public class GZIPFilter extends OncePerRequestFilter {
    private final transient Logger log = LoggerFactory.getLogger(GZIPFilter.class);
