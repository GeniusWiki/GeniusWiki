...
/**
 * NDPNDP - some small fix in this code. Need search "NDPNDP" to locate it:)
 * 
...
public class ProgressBar extends Widget implements ResizableWidget {
  ...
  public void setProgress(double curProgress) {
    ...
    //NDPNDP - IE 6 has reported this is an issue if width=0%
    if(percent > 0)
    	DOM.setStyleAttribute(barElement, "width", percent + "%");
    else
    	DOM.setStyleAttribute(barElement, "width", "1px");
