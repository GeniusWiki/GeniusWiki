...
public class UserSearchServiceImpl extends AbstractSearchService implements UserSearchService {
	...
	public SearchResult searchUser(String keyword, int currPageNumber,int returnCount, User user) throws SearchException {
		...
		return commonSearch(keyword, currPageNumber,returnCount,user,Character.valueOf(SearchService.ADV_SOURCE_TYPES).toString()+SearchService.INDEX_USER);
	}
