 ...
 * @author Dapeng.Ni
 */
public class MyFavoriteWidget extends AbstractWidgetTemplate {
	Widget obj = null;
	...
	public Widget createWidgetObject(String key) {
		if(obj == null){
			obj = new Widget();
			obj.setType(getType());
			obj.setUuid(SharedConstants.FAVORITE_KEY);
			obj.setTitle(messageService.getMessage(WikiConstants.I18N_FAVORITE_TITLT));
			obj.setDescription(messageService.getMessage(WikiConstants.I18N_FAVORITE_DESC));
		}
		return obj;
	}
	...
	public Widget invoke(String key,User viewer) {
		...
		List<Page> pages = pageService.getFavoritePages(username);
