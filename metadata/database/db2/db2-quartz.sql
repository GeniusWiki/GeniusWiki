...
foreign key (job_name,job_group) references @TOKEN.TABLE.PREFIX@QRTZ_job_details(job_name,job_group)
);
...
primary key (trigger_name,trigger_group),
foreign key (trigger_name,trigger_group) references @TOKEN.TABLE.PREFIX@QRTZ_triggers(trigger_name,trigger_group)
);
