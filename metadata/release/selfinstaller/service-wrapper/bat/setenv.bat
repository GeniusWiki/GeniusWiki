...
rem configuration file used by all bat files - Edgenius: this is comments as it needs specified for webserver or database.
rem set conf_file="%wrapper_home%/conf/wrapper.conf"
