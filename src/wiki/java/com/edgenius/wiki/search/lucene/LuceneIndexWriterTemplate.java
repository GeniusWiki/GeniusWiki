 ...
 * @author Dapeng.Ni
 */
public class LuceneIndexWriterTemplate {
	private static final Logger log = LoggerFactory.getLogger(LuceneIndexWriterTemplate.class);
	
	private IndexFactory indexFactory;
	
	public LuceneIndexWriterTemplate(IndexFactory indexFactory) {
	...
	public void addDocument(Document document) {
		...
		try {
			...
			throw new LuceneIndexAccessException("Error during add a document.",ex);
		}
	}
