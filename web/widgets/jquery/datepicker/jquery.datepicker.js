...
; (function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            var cpHA = [];
            cpHA.push("<div id='BBIT_DP_CONTAINER' class='bbit-dp' style='display:none;width:175px;z-index:999;'>");
            if ($.browser.msie6) {
