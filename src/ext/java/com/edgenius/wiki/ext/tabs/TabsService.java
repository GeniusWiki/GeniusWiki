 ...
 * @author Dapeng.Ni
 */
public class TabsService implements PluginServiceProvider {


	public Map<File, String> exportResources() {
		Map<File, String> map = new HashMap<File, String>();
		map.put(new File(FileUtil.getFullPath(Global.ServerInstallRealPath, "plugins","tabs","resources","tabs-print.css")),
				FileUtil.getFullPath( "plugins","tabs","resources"));
		return map;
	}
