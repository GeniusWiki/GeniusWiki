...
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_locks IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_scheduler_state IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_fired_triggers IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_paused_trigger_grps IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_calendars IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_trigger_listeners IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_blob_triggers IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_cron_triggers IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_simple_triggers IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_triggers IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_job_listeners IF EXISTS;
DROP TABLE  @TOKEN.TABLE.PREFIX@qrtz_job_details IF EXISTS;
