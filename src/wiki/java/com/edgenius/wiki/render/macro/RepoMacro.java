...
import com.edgenius.wiki.render.handler.RepoHandler;
import com.edgenius.wiki.render.object.ObjectPosition;

/**
 * List all attachments from specified space
 * @author Dapeng.Ni
 */
public class RepoMacro extends BaseMacro {
	
	private final static String HANDLER = RepoHandler.class.getName();
	
	//JDK1.6 @Override
	public String[] getName() {
		return new String[]{"repo","repository"};
	}
	@Override
	public String getHTMLIdentifier() {
		return "<div aid='repository'>";
	}
	//JDK1.6 @Override
	...
	protected void replaceHTML(HTMLNode node, ListIterator<HTMLNode> iter, RenderContext context) {
		resetMacroMarkup(TIDY_STYLE_BLOCK, node, iter, getMacroMarkupString(node, "repo"), null);
