 ...
 * @author Dapeng.Ni
 */
public class ExportMethodValueProvider  implements MethodValueProvider{
	
	public static final String exportSpace = "exportSpace";
	public static final String importSpace = "importSpace";
	...
	public boolean isSupport(String clz) {
		...
		return RenderServiceImpl.class.getName().equals(clz);
	}
