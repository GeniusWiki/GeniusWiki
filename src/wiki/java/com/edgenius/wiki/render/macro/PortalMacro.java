...
/**
 * @author Dapeng.Ni
 * {portal:columns=3|showLogo=true}
 */
public class PortalMacro extends BaseMacro {
	...
	public void execute(StringBuffer writer, MacroParameter params) throws MalformedMacroException {
		...
		obj.values.put(NameConstants.MACRO, SharedConstants.MACRO_PORTAL);
	...
	protected void replaceHTML(HTMLNode node, ListIterator<HTMLNode> iter, RenderContext context) {
		resetMacroMarkup(TIDY_STYLE_BLOCK, node, iter, getMacroMarkupString(node, "portal"), null);
